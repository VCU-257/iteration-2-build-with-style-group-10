        ...
        <div>
                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        <ul class="navbar-nav ms-auto">
                            <li class="nav-item"><a class="nav-link text-primary active" href="transactions.html"><i
            ...
            <div class="d-flex d-md-none fixed-bottom bg-light border-top text-center fs-5">
                <a href="transactions.html" class="flex-fill py-2"><i
                    class="bi bi-currency-dollar text-primary"></i></a>
            ...
            <div class="container pt-3 pb-5">
                <p> Welcome to the fake Transactions Page</p>
            </div>
        </div>
    );
}
